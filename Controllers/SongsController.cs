...
namespace Projekt.Controllers
{
    public class SongsController : Controller
    {
        ...
        public SongsController(MusicDatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var musicDatabaseContext = _context.Songs.Include(s => s.Album);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MusicDatabaseContext.Songs'  is null.");
            }
            var song = await _context.Songs.FindAsync(id);
            if (song != null)
            {
